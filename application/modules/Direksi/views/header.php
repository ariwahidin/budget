...
<body class="hold-transition skin-black-light <?= $this->uri->segment(2) == 'setOperatingActivity' ? '' : 'sidebar-mini' ?> <?= $this->uri->segment(2) == 'ShowDetailBudget' || $this->uri->segment(2) == 'setOperatingActivity' || $this->uri->segment(2) == 'createOperating2' || $this->uri->segment(2) == 'show_form_proposal_from_sales' || $this->uri->segment(2) == 'showFormAddOnTop' || $this->uri->segment(2) == 'showProposal' ? 'sidebar-collapse' : '' ?>" style="height: auto; min-height: 100%;">
    <div class="wrapper">
