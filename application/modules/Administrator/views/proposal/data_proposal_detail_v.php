...
<?php 
    // var_dump($operatingProposal->result());
?>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <table>
                                    ...
                                    <tr>
                                        <td>YTD Operating</td>
                                        <td>&nbsp;:&nbsp;<b><?= number_format($operatingProposal->row()->YTD_operating) ?></b></td>
                                    </tr>
                                    <tr>
                                        <td>YTD Actual</td>
                                        <td>&nbsp;:&nbsp;<b><?= number_format($operatingProposal->row()->YTD_purchase) ?></b></td>
                                    </tr>
                                    <tr>
                                        <td>YTD Used Budget</td>
                                        <td>&nbsp;:&nbsp;<b><?= number_format(getUsedBudgetActivity($operatingProposal->row()->BudgetCodeActivity)) ?></b></td>
                                    </tr>
                                    <tr>
                                        <td>Balance Operating</td>
                                        <td>&nbsp;:&nbsp;<b><?= number_format($operatingProposal->row()->RealBudget) ?></b></td>
                                    </tr>
                                    <tr>
                                        <td>Total Costing</td>
