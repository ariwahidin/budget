                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table class="table table-responsive table-bordered table-striped table_operating_purchase">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($operating_purchase->result() as $data) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        <td>
                                            <a href="<?=base_url($_SESSION['page'].'/deleteBudget/'.$data->BudgetCode)?>" class="btn btn-danger btn-xs">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<script>
    $('.table_operating_purchase').DataTable({resposive : true});
</script>