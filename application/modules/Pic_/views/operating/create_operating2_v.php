                            ...
                            <table class="table table-responsive table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Month</th>
                                        <th>Target (<?= $_POST['valas'] ?>)</th>
                                        <th>Target (IDR)</th>
                                        <th>A&P (<?= $_POST['valas'] ?>)</th>
                                        <th>A&P (IDR) (<?= $_POST['percent_anp'] ?>%)</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($periode as $month) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="principal_target_valas[]" onpaste="calculating(this)" onkeypress="javascript:return isNumber(event)" onkeyup="formatNumber(this); calculating(this)" class="form-control input_principal_target_aud">
                                            </td>
                                            <td>
                                                <input type="text" name="principal_target_idr[]" onkeypress="javascript:return isNumber(event)" onkeyup="formatNumber(this)" class="form-control input_principal_target_idr" readonly>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" name="anp_principal_idr[]" onkeypress="javascript:return isNumber(event)" onkeyup="formatNumber(this)" class="form-control input_target" readonly>
                                            </td>
                                            <td>
