...
<script type="text/javascript">
    ...
    function chooseItemForRegularForm(){
        item_code = []
        ...
        for(var i = 0; i < item_code.length; i++){  
            ...
            tr.classList.add('rowTableTarget');
            var tdValuePromo = document.createElement('td');
            var inputValuePromo = document.createElement('input');
            inputValuePromo.classList.add('inputValuePromo','form-control');
            inputValuePromo.setAttribute('readonly','readonly');
            tdValuePromo.appendChild(inputValuePromo);
            tr.appendChild(tdProduct);
            tr.appendChild(tdBarcode);
            tr.appendChild(tdPrice);
            tr.appendChild(tdTarget);
            tr.appendChild(tdTotalTarget);
            tr.appendChild(tdValuePromo);
